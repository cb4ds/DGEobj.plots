...
test_that("obsPlot.R: obsPlot()", {
    ...
    expect_error(expect_warning(obsPlot(obj_no_rep_group,
                                        group = "replicateGroup"),
                                msg = "group must be specified and should be one of the columns in the design object in DGEdata."),
                 msg = "Unable to find default column 'ReplicateGroup' in the design item. Provide a valid column from the design object in DGEdata")
