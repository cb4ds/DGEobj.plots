...
# only one of each is present. Plot can be created using either canvasXpress or ggplot library. 
designMatrix <- getType(dgeObj, "designMatrix")[[1]]
dgelist <- getType(dgeObj, "DGEList")[[1]]
# Dispersion plot
dispersionPlot_cx <- plotDispersion(dgelist, 
                                    designMatrix,     
                                    lineFit = "loess", 
                                    plotCategory = "dispersion", 
                                    plotType = "canvasXpress")
printAndSave(dispersionPlot, file.path(outputPath, "dispersionPlot_cx.png"))

dispersionPlot_ggplot <- plotDispersion(dgelist, 
                                        designMatrix, 
                                        lineFit = "loess", 
                                        plotCategory = "dispersion", 
                                        plotType = "ggplot")
printAndSave(dispersionPlot, file.path(outputPath, "dispersionPlot_ggplot.png"))

# BCV (biological coefficient of variation) plot
BCV_Plot_cx <- plotDispersion(dgelist, 
                              designMatrix, 
                              lineFit = "loess", 
                              plotCategory = "BCV", 
                              plotType = "canvasXpress")
printAndSave(BCV_Plot, file.path(outputPath, "BCV_Plot_cx.png"))

BCV_Plot_ggplot <- plotDispersion(dgelist, 
                                  designMatrix, 
                                  lineFit = "loess", 
                                  plotCategory = "BCV", 
                                  plotType = "ggplot")
printAndSave(BCV_Plot, file.path(outputPath, "BCV_Plot_ggplot.png"))
```
...
Input can be a DGEobj or a raw counts matrix.  Output can be a canvasXpress or ggplot object that is either a box plot or density distribution. 

Default plot type is a canvasXpress and default plot category is box plot.

```
boxNorm <- plotNorm(dgeObj, plotType = "canvasXpress", plotCategory = "box", normalize = "tmm")
printAndSave(boxNorm, file.path(outputPath, "boxNorm.png"))

densityNorm <- plotNorm(dgeObj, plotType = "ggplot", plotCategory = "density", normalize = "tmm")
